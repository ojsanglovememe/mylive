 ...
 * @class 直线viewpager指示器，带颜色渐变、阴影
 * @time 2018/4/26 0026 09:46
 * @change
 * @chang time
 * @class describe
 */

public class ShadowPagerIndicator extends View implements IPagerIndicator {
    ...
    public ShadowPagerIndicator(Context context) {
        super(context);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        mPaint.setShadowLayer(5,5,5, ContextCompat.getColor(context, R.color.colorTabProjection));
