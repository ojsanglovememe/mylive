 ...
 */
public class VideoPlayerDisplay implements Renderer {
    ...
    private void prepareVideoAndStart() {
        ...
        mMediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                // 在播放完毕被回调
                Message msg = mHandler.obtainMessage(PublisherActivity.MSG_STOP_RECORDING);
...
//        LogUtils.i(TAG, "render fps: %f", mFps);
    ...
    private void setUpVideo() {
        ...
        mGLRender.adjustTextureBuffer(180, false);
