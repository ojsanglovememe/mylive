...
import com.src.isec.utils.shareutils.share.instance.DefaultShareInstance;
import com.src.isec.utils.shareutils.share.instance.QQShareInstance;
import com.src.isec.utils.shareutils.share.instance.ShareInstance;
import com.src.isec.utils.shareutils.share.instance.WeiboShareInstance;
import com.src.isec.utils.shareutils.share.instance.WxShareInstance;
...
public class ShareUtil {
    ...
    public static void shareText(Context context, @SharePlatform.Platform int platform, String text,
        ...
        if(!isInstalled(context, platform)){
            showToast(context, getErrorToastText(context, platform));
            return;
        }
        mType = TYPE_TEXT;
        mText = text;
    ...
    public static void shareMedia(Context context, @SharePlatform.Platform int platform,
        ...
        mType = TYPE_MEDIA;
        mPlatform = platform;
        mShareImageObject =  shareEntity.getThumb() == null ? new ShareImageObject(shareEntity.getThumbUrlOrPath()) : new ShareImageObject(shareEntity.getThumb());
        mSummary = shareEntity.getSummary();
    ...
    public static boolean isInstalled(Context context, @SharePlatform.Platform int platform) {
        switch (platform) {
            case SharePlatform.QQ:
            case SharePlatform.QZONE:
    ...
    private static String getErrorToastText(Context context, @SharePlatform.Platform int platform){
        switch (platform) {
            case SharePlatform.QQ:
            case SharePlatform.QZONE:
                return context.getString(R.string.toast_please_install_qq);
            case SharePlatform.WEIBO:
                return context.getString(R.string.toast_please_install_sina);
            case SharePlatform.WX:
            case SharePlatform.WX_TIMELINE:
                return context.getString(R.string.toast_please_install_weixin);
            case SharePlatform.DEFAULT:
                return context.getString(R.string.toast_no_share);
            default:
                return context.getString(R.string.toast_no_share);
        }
    }
