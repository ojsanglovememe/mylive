 ...
 * @author liujiancheng
 * @name IsecLive
 * @class name：com.src.isec.data.network.http.log
 * @class 对 OkHttp 的请求和响应信息进行更规范和清晰的打印,可更根据自己的需求自行扩展打印格式
...
public interface FormatPrinter {
    ...
    void printJsonResponse(long chainMs, boolean isSuccessful, int code, String headers,
                           ...
                           String bodyString, List<String> segments, String message, String
                                   responseUrl);
